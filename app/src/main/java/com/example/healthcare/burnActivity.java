...
public class burnActivity extends AppCompatActivity implements LocationListener {
        ...
        FirebaseDatabase.getInstance().getReference("Current Location"+currentTime).setValue(helper).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(burnActivity.this, "Location Saved", Toast.LENGTH_SHORT).show();
                } else{
                    Toast.makeText(burnActivity.this, "Location Not Saved", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
